...
function($, window) {
    ...
    if (app.corejs.indexOf('?') > -1) {
        app.cacheBust = app.corejs.substring(app.corejs.indexOf('?'));;
    ...
    app.config = function(options) {
        ...
        if (app.defaults.cacheBust !== '') {
            if (app.defaults.cacheBust.indexOf('?') === -1) {
                app.defaults.cacheBust = '?' + app.defaults.cacheBust;
            }
        } else {
            app.defaults.cacheBust = app.cacheBust;
        }
...
function($, window) {
    ...
    sidebar.init = function() {
        ...
        $(document).on('click', '.sidebar .menu-link', function() {
            ...
            if ($(this).closest('.sidebar').hasClass('sidebar-floating-menu') && !$('body').hasClass('sidebar-open')) {
                return;
            }
